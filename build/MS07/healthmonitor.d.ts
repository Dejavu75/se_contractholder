export declare enum heartbeatServiceType {
    UNKNOWN = "unknow",
    MS = "ms",
    NGEC = "ngec",
    AGES = "ages",
...
export declare class cnt_heartbeat implements sch_heartbeat {
    ...
    get alert(): Date | null;
    get down(): Date | null;
    constructor(mscode?: string, instance?: string, status?: string, version?: number, createdAt?: Date, updateAt?: Date, url?: string, expectedInterval?: number, action?: string, serviceType?: heartbeatServiceType, heartbeatAt?: Date, extraData?: string);
