...
export declare class cnt_mantErrorHolder implements sch_mantErrorHolder {
    ...
    quantityRequested: number;
    type: number;
    constructor(origin?: string, type?: number, code?: string, bul?: string, atr?: string, deposit?: string, lot?: string, quantity?: number, quantityRequested?: number, errorid?: string);
